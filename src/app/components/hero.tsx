                    ...
                    <div className="flex flex-col items-start ml-32 animate-slide-down">
                        ...
                        <div className="my-8 flex gap-4">
                            ...
                            <div className="relative group">
                                ...
                                <svg className="hover:fill-teal-300 transition-colors duration-100 mt-0.5" stroke="currentColor" fill="#dc2626" strokeWidth="0" viewBox="0 0 512 512" height="23px"
                                    width="23px" xmlns="http://www.w3.org/2000/svg"><path d="M497.39 361.8l-112-48a24 24 0 0 0-28 6.9l-49.6 60.6A370.66 370.66 0 0 1 130.6 204.11l60.6-49.6a23.94 23.94 0 0 0 6.9-28l-48-112A24.16 24.16 0 0 0 122.6.61l-104 24A24 24 0 0 0 0 48c0 256.5 207.9 464 464 464a24 24 0 0 0 23.4-18.6l24-104a24.29 24.29 0 0 0-14.01-27.6z"></path></svg>
                        ...
                        <button className="relative px-5 py-3 overflow-hidden font-medium text-white bg-gray-900 border border-red-600 hover:border-gray-100 rounded-lg shadow-inner group">
                            ...
                            <span className="relative transition-colors duration-300 delay-200 group-hover:text-white ease rounded-lg ">
                                <a href="/resume.pdf" download>Donwload resume</a>
                            </span>
                        </ button>
                    </div>
                    <div className="mr-24">
